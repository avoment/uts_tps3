...
<body id="page-top">
  ...
  <tr>
    ...
    <td><a href="e_jasa.php?id=<?php echo $d['id']?>" class="btn1">Edit</a> | <a href="act/d_jasa.php?id=<?php echo $d['id']?>" class="btn2" >Delete</a></td>
...
?>
          ...
          <div class="row">
            <div class="col-lg-12">
                      <a href="f_jasa.php" align="center" class="btn btn-primary">Tambah Jasa</a>
                      </div>
            </div>
          </div>
