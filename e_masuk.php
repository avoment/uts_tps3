        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              $id = $_GET['id'];
              $data = mysqli_query($mysqli, "SELECT * FROM t_masuk WHERE id_trans='".$id."'");
              while($d = mysqli_fetch_array($data)){
              ?>

              <div class="card mb-4">
                <form method="post" action="act/u_masuk.php">
                ...
                <div class="card-body">
                  <form>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputEmail3" value="<?php echo $d['id_trans']; ?>"name="id_trans">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPassword3" class="col-sm-3 col-form-label">Tanggal Masuk</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputPassword3" value="<?php echo $d['tgl_masuk']; ?>" name="tgl_masuk">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Nama</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputEmail3" value="<?php echo $d['nama']; ?>" name="nama_cus">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Jasa</label>
                      <div class="col-sm-9">
                        <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo $d['jasa']; ?></label>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputEmail3" value="<?php echo $d['berat']; ?>" name="berat">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">total</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputEmail3" value="<?php echo $d['total']; ?>" name="total">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-10">
                        ...
                        <a href="datamasuk.php" align="center" class="btn btn-primary">Batal</a>
