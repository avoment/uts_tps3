        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                <form method="post" action="act/u_sabun.php">
                ...
                <div class="card-body">
                  <form>
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Sabun</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputEmail3" value="<?php echo $d['sabun']; ?>"name="sabun">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPassword3" class="col-sm-3 col-form-label">Softener</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputPassword3" value="<?php echo $d['softener']; ?>" name="softener">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Parfum</label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-10">
                        ...
                        <a href="datasabun.php" align="center" class="btn btn-primary">Batal</a>
