...
<head>
  ...
  <title>Laundry Bersih - DataJasa</title>
...
<body id="page-top">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Data Jasa Dalam Proses</h6>
                </div>
  ...
  $no = 1;
  $data = MySQLi_query($mysqli,"SELECT * from t_masuk where status='Dalam Proses'");
  ...
  <tr>
    ...
    <td><a href="e_masuk.php?id=<?php echo $d['id_trans']?>" class="btn1">Edit</a> | <a href="act/d_masuk.php?id=<?php echo $d['id_trans']?>" class="btn2" >Delete</a>
      | <a href="act/u_siapambil.php?id=<?php echo $d['id_trans']?>" class="btn2" >Siap Ambil</a></td>
...
?>
          ...
          <div class="row">
            <div class="col-lg-12">
                      <a href="f_masuk.php" align="center" class="btn btn-primary">Tambah Transaksi</a>
                      </div>
            </div>
          </div>
